...
<body>
    <form id="form1" runat="server">
        ...
        <div style="text-align: center; font-size: large">
            ...
            <asp:RequiredFieldValidator ID="rfvLogin" runat="server" ControlToValidate="tbLogin" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            ...
            <asp:RequiredFieldValidator ID="rfvQuestion" runat="server" ControlToValidate="tbQuestion" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            <div class="delimeter"></div>
            <asp:Label ID="labAnswer" runat="server" Text="Answer"></asp:Label>
            <br />
            <asp:TextBox ID="tbAnswer" runat="server" Width="200px"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvAnswer" runat="server" ControlToValidate="tbAnswer" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
            <div class="delimeter"></div>
            <br />
